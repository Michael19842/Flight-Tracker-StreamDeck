namespace FlightStreamDeck.Logics
{
    public enum KnownEvents
    {
        ...
        // Microsoft Flight Simulator 2020 Additional Modern Events
        EMERGENCY_GEAR_EXTENSION,
        CARGO_DOOR_TOGGLE,
        SERVICE_DOOR_TOGGLE,
        RAIN_REPELLENT_TOGGLE,
        ICE_DETECTOR_TOGGLE,
        HYDRAULIC_SWITCH_1,
        HYDRAULIC_SWITCH_2,
        HYDRAULIC_SWITCH_3,
        ...
        OXYGEN_ON,
        OXYGEN_OFF,
        PRESSURIZATION_MODE_AUTO,
        PRESSURIZATION_MODE_MANUAL,
        EMERGENCY_DESCENT_MODE,
        TERRAIN_AHEAD_PULL_UP,
        WINDSHEAR_WARNING,
        STALL_WARNING_HORN,
        OVERSPEED_WARNING,
        ALTITUDE_ALERT,
        MINIMUMS_RESET,
        RADIO_ALTIMETER_TEST,
        GPWS_TERRAIN_INHIBIT,
        TCAS_TA_ONLY,
        TCAS_TA_RA,
        TCAS_TEST,
        WEATHER_RADAR_TILT_UP,
        WEATHER_RADAR_TILT_DOWN,
        WEATHER_RADAR_GAIN_UP,
        WEATHER_RADAR_GAIN_DOWN,
        TURBULENCE_DETECTOR,
        LIGHTNING_DETECTOR,
        WINDSHEAR_DETECTOR
    }
